...
public class AddressBookDataComparator {
    ...
    static {
        ...
        addressBookComparator.put(AddressBookRequirements.CompareType.LAST_NAME,Comparator.comparing(iplData ->
                                                                                            iplData.getLastName()));
        addressBookComparator.put(AddressBookRequirements.CompareType.ZIP,Comparator.comparing(iplData ->
                                                                                            iplData.getZip()));
        addressBookComparator.put(AddressBookRequirements.CompareType.STATE,Comparator.comparing(iplData ->
                                                                                            iplData.getState()));
        addressBookComparator.put(AddressBookRequirements.CompareType.CITY,Comparator.comparing(iplData ->
                                                                                            iplData.getCity()));
    }
